...
with DAG(dag_id='fisheries',
    ...
    def extract_data(offset):
        ...
        endpoint=f'/https://misfisheries.bihar.gov.in/fisheriesbipard.asmx/BindJalkar?count={count}&offset={offset}'
    ...
    offset=get_offset('fisheries') #change table name here 
    t_data=extract_data(offset=offset)
    trans_data=transform_data(t_data)
    load_data(trans_data,'fisheries')
