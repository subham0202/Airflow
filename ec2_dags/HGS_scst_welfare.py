...
with DAG(dag_id='HGS_scst_welfare',
    ...
    def extract_data(offset):
        ...
        endpoint=f'/nic-data?url=http://164.100.251.114/scst/scst/hss/tbl-beneficiary-details&count={count}&offset={offset}'
    ...
    offset=get_offset('HGS_scst_welfare') #change table name here 
    t_data=extract_data(offset=offset)
    trans_data=transform_data(t_data)
    load_data(trans_data,'HGS_scst_welfare')
