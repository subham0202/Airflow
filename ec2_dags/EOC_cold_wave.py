...
with DAG(dag_id='EOC_cold_wave_details',
    ...
    def extract_data(offset):
        ...
        endpoint=f'/nic-data?url=http://164.100.251.114/disaster/disaster-management/eoc/cold-wave-details&count={count}&offset={offset}'
    ...
    offset=get_offset('EOC_cold_wave_details') #change table name here 
    t_data=extract_data(offset=offset)
    trans_data=transform_data(t_data)
    load_data(trans_data,'EOC_cold_wave_details')
