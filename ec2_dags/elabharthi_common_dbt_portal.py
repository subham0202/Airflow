...
# Define constants
base_url = "http://164.100.251.114/finance/finance/edbt/"
prefix = "eLabharthi_Common_DBT_Portal_"
...
apis = [
    "block",
    "dbtreportdata",
    "dbt-report-data-state",
    "dbt-report-data-mdm",
    "dbtrequestid",
    "department",
    "deptwise-schm-fin-summary",
    "district",
    "fin-yr-data",
    "fyear",
    "panchayat",
    ...
    "scheme-budget",
    "scheme-type",
    "tbl-elabharthi-fyear-wise",
    "tbl-elabharthi-201920",
    "tbl-schemetype-payment",
    "village-master",
    "months",
]
...
# Create the DAG
with DAG(
    dag_id='elabharthi_common_dbt_portal',
