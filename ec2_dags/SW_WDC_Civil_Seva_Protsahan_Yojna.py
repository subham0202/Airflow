...
with DAG(dag_id='SW_WDC_Civil_Seva_Protsahan_Yojna',
    ...
    def extract_data(offset):
        ...
        endpoint=f'/nic-data?url=http://164.100.251.114/wdc/wdc/eupi-payment-bill-details&count={count}&offset={offset}'
    ...
    offset=get_offset('SW_WDC_Civil_Seva_Protsahan_Yojna') #change table name here 
    t_data=extract_data(offset=offset)
    trans_data=transform_data(t_data)
    load_data(trans_data,'SW_WDC_Civil_Seva_Protsahan_Yojna')
