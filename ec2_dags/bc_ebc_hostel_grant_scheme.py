...
with DAG(dag_id='bc_ebc_hostel_grant_scheme',
    ...
    def extract_data(offset):
        ...
        endpoint=f'/nic-data?url=http://164.100.251.114/bcebc/bcebc/hss/tbl-payment-bill-gen&count={count}&offset={offset}'
    ...
    offset=get_offset('bc_ebc_hostel_grant_scheme') #change table name here 
    t_data=extract_data(offset=offset)
    trans_data=transform_data(t_data)
    load_data(trans_data,'bc_ebc_hostel_grant_scheme')
