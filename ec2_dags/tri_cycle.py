...
with DAG(dag_id='tri_cycle',
    ...
    def extract_data(offset):
        ...
        endpoint=f'/nic-data?url=http://164.100.251.114/dod/disability/personal_details&count={count}&offset={offset}'
    ...
    offset=get_offset('tri_cycle') #change table name here 
    t_data=extract_data(offset=offset)
    trans_data=transform_data(t_data)
    load_data(trans_data,'tri_cycle')
