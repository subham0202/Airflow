...
with DAG(dag_id='jjhm',
    ...
    def extract_data(offset):
        ...
        endpoint=f'//nic-data?url=http://164.100.251.114/rdd/rural-development/jjhm/building-bill-details&count={count}&offset={offset}'
    ...
    offset=get_offset('jjhm') #change table name here 
    t_data=extract_data(offset=offset)
    trans_data=transform_data(t_data)
    load_data(trans_data,'jjhm')
