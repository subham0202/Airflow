...
with DAG(dag_id='jp_Senani',
    ...
    def get_offset(name: str) -> int:
        ...
        try:
            ...
            print(f"Ersdasdsadror fetching count from table {name}: {e}")
            return -1
    ...
    def extract_data(offset):
        ...
        endpoint=f'/nic-data?url=http://164.100.251.114/home/home/jp-senani/beneficiary-jp-senani&count={count}&offset={offset}'
    ...
    offset=get_offset('jp_Senani') #change table name here 
    t_data=extract_data(offset=offset)
    trans_data=transform_data(t_data)
    load_data(trans_data,'jp_Senani')
