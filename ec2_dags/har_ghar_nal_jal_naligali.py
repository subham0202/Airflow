...
with DAG(dag_id='har_ghar_nal_ka_jal_nali_gali',
    ...
    def extract_data(offset):
        ...
        endpoint=f'/nic-data?url=http://164.100.251.114/pr/pr/scheme-profile-naligali&count={count}&offset={offset}'
    ...
    load_data(trans_data,'har_ghar_nal_ka_jal_nali_gali')
